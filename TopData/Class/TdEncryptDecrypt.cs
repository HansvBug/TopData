namespace TopData
{
    ...
    /// </summary>
    public static class TdEncryptDecrypt
    {
        // Bron : http://www.codeproject.com/Articles/5719/Simple-encrypting-and-decrypting-data-in-C
        ...
        ///  </summary>
        /// <param name="clearText">The text.</param>
        ...
        /// </summary>
        /// <param name="clearData">The text.</param>
        /// <param name="password">The password.</param>
        /// <returns>An arrray of byte.</returns>
        ...
        /// </summary>
        /// <param name="fileIn">The file which needs te be encrypted.</param>
        /// <param name="fileOut">The encrypted file.</param>
        /// <param name="password">The password.</param>
        ...
        /// </summary>
        /// <param name="cipherData">Cipher.</param>
        ...
        /// </summary>
        /// <param name="fileIn">The encrypted file.</param>
        /// <param name="fileOut">The decrypted file.</param>
        /// <param name="password">Password.</param>
        public static void Decrypt(string fileIn, string fileOut, string password)
        {
            // First we are going to open the file stream
            FileStream fsIn = new(fileIn, FileMode.Open, FileAccess.Read);
            FileStream fsOut = new(fileOut, FileMode.OpenOrCreate, FileAccess.Write);
    ...
    /// <summary>
    /// Encrypt and verify user password. password will be Hashed so one way only.
    /// </summary>
    public static class EncryptDecryptUserData
    {
        // bron : https://janaks.com.np/password-hashing-in-csharp/
        // 24 = 192 bits
        ...
        /// <param name="hashByteSize">The hashByteSize.</param>
        /// <returns>Array of byte.</returns>
        ...
        /// Generate a new salt.
        /// </summary>
        /// <param name="saltByteSize">the byte size of the salt.</param>
        ...
        /// </summary>
        /// <param name="password">The password.</param>
        /// <param name="passwordSalt">the passwaor-salt combi.</param>
